...
protected:
  friend class TcpRC3Sack;   //Added by Radhika
  friend class TcpRCP;         //Added by Radhika
  ...
  virtual void     SendSynAck(Ptr<Packet> p);
  ...
  virtual void ProcessListen (Ptr<Packet>, const TcpHeader&, const Address&, const Address&); // Process the newly received ACK
